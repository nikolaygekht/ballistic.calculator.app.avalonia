...
/// <summary>
/// A compass-style dial for the shot azimuth. 0° points UP (North) and increases clockwise;
/// the arrow points outward from the center (shooter) toward the target along the bearing.
/// Click or drag inside the circle to set the bearing.
/// </summary>
public partial class AzimuthDirectionControl : UserControl
{
    private readonly AzimuthDirectionController _controller;
    ...
    public static readonly StyledProperty<IBrush> StrokeBrushProperty =
        AvaloniaProperty.Register<AzimuthDirectionControl, IBrush>(nameof(StrokeBrush), Brushes.Black);

    public static readonly StyledProperty<double> StrokeThicknessProperty =
        AvaloniaProperty.Register<AzimuthDirectionControl, double>(nameof(StrokeThickness), 2.0);

    #endregion

    #region Properties

    /// <summary>Azimuth in degrees (0-360). 0 = North (up), 90 = East (right), clockwise.</summary>
    ...
    public AzimuthDirectionControl()
    {
        _controller = new AzimuthDirectionController();
        InitializeComponent();
    ...
    private void CreateDrawingElements()
    {
        ...
        _circle = new Ellipse { Stroke = StrokeBrush, StrokeThickness = StrokeThickness, Fill = Brushes.Transparent };
        _arrowLine = new Line { Stroke = StrokeBrush, StrokeThickness = StrokeThickness };
        _arrowHead1 = new Line { Stroke = StrokeBrush, StrokeThickness = StrokeThickness };
        _arrowHead2 = new Line { Stroke = StrokeBrush, StrokeThickness = StrokeThickness };
    ...
    {
        var newDirection = Math.Round(_controller.DirectionFromClick(Bounds.Width, Bounds.Height, x, y));
